...
>>> do_rewrite('/other.html', '20130907*/http://example.com/path/page.html', 'http://localhost:8087/coll/')
...
>>> do_rewrite('../../other.html', '*/http://example.com/index.html', 'localhost:8087/')
'localhost:8087/*/http://example.com/other.html'

>>> do_rewrite('path/../../other.html', '*/http://example.com/index.html', 'localhost:8087/')
'localhost:8087/*/http://example.com/other.html'

>>> do_rewrite('http://some-other-site.com', '20101226101112/http://example.com/index.html', 'localhost:8087/')
'localhost:8087/20101226101112/http://some-other-site.com'

>>> do_rewrite('http://localhost:8087/web/2014im_/http://some-other-site.com', 'http://example.com/index.html', '/web/', full_prefix='http://localhost:8087/web/')
'http://localhost:8087/web/2014im_/http://some-other-site.com'

>>> do_rewrite('/web/http://some-other-site.com', 'http://example.com/index.html', '/web/', full_prefix='http://localhost:8087/web/')
'/web/http://some-other-site.com'

>>> do_rewrite(r'http:\/\/some-other-site.com', '20101226101112/http://example.com/index.html', 'https://localhost:8087/')
'https://localhost:8087/20101226101112/http:\\\\/\\\\/some-other-site.com'

>>> do_rewrite(r'//some-other-site.com', '20101226101112/http://example.com/index.html', 'http://localhost:8087/')
'//localhost:8087/20101226101112///some-other-site.com'

>>> do_rewrite(r'\/\/some-other-site.com', '20101226101112/http://example.com/index.html', 'http://localhost:8087/')
'//localhost:8087/20101226101112/\\\\/\\\\/some-other-site.com'

>>> do_rewrite(r'\\/\\/some-other-site.com', '20101226101112/http://example.com/index.html', 'https://localhost:8087/')
'//localhost:8087/20101226101112/\\\\/\\\\/some-other-site.com'

>>> do_rewrite(r'http:\/\/some-other-site.com', '20101226101112/http://example.com/index.html', 'https://localhost:8087/')
'https://localhost:8087/20101226101112/http:\\\\/\\\\/some-other-site.com'

>>> do_rewrite(r'http:\/\/some-other-site.com', '20101226101112/http://example.com/index.html', 'http://localhost:8087/')
'http://localhost:8087/20101226101112/http:\\\\/\\\\/some-other-site.com'
...
# deprefix tests
>>> do_deprefix('2013id_/http://example.com/file/path/blah.html?param=http://localhost:8087/pywb/20141226/http://example.com/', '/pywb/', 'http://localhost:8087/pywb/')
'http://example.com/file/path/blah.html?param=http://example.com/'

>>> do_deprefix('2013id_/http://example.com/file/path/blah.html?param=http://localhost:8087/pywb/if_/https://example.com/filename.html', '/pywb/', 'http://localhost:8087/pywb/')
'http://example.com/file/path/blah.html?param=https://example.com/filename.html'

>>> do_deprefix('2013id_/http://example.com/file/path/blah.html?param=http://localhost:8087/pywb/https://example.com/filename.html', '/pywb/', 'http://localhost:8087/pywb/')
'http://example.com/file/path/blah.html?param=https://example.com/filename.html'

>>> do_deprefix('http://example.com/file.html?param=http://localhost:8087/pywb/https%3A//example.com/filename.html&other=value&a=b&param2=http://localhost:8087/pywb/http://test.example.com', '/pywb/', 'http://localhost:8087/pywb/')
'http://example.com/file.html?param=https://example.com/filename.html&other=value&a=b&param2=http://test.example.com'

# urlencoded
>>> do_deprefix('http://example.com/file.html?foo=bar&url=' + quote_plus('http://localhost:8087/pywb/http://example.com/filename.html') + '&foo2=bar2', '/pywb/', 'http://localhost:8087/pywb/')
'http://example.com/file.html?foo=bar&url=http://example.com/filename.html&foo2=bar2'

# with extra path
>>> do_deprefix('http://example.com/file.html?foo=bar&url=' + quote_plus('http://localhost:8087/pywb/extra/path/http://example.com/filename.html') + '&foo2=bar2', '/pywb/', 'http://localhost:8087/pywb/')
'http://example.com/file.html?foo=bar&url=http://example.com/filename.html&foo2=bar2'
...
>>> UrlRewriter('http://example.com/vucht.php', 'http://localhost:8087/live/').rewrite('js/bundle.php?v=1', 'js_', True)
'/live/js_/http://example.com/js/bundle.php?v=1'

>>> UrlRewriter('http://example.com/vucht.php', 'http://localhost:8087/live/').rewrite('js/bundle.php?v=1', 'js_')
'js/bundle.php?v=1'
